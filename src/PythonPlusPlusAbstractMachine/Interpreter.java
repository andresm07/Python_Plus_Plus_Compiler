...
// DATA STORE REGISTERS AND OTHER REGISTERS
    ...
    final static int SB = 0;
    final static int HB = 1024; // = Upper bound of data array + 1
    ...
    final static int halted = 1;
    final static int failedDataStoreFull = 2;
    final static int failedInvalidCodeAddress = 3;
    final static int failedInvalidInstruction = 4;
    final static int failedOverflow = 5;
    final static int failedZeroDivide = 6;
    final static int failedIOError = 7;
    ...
    static void showStatus() {
        ...
        switch(status) {
            ...
            case failedInvalidInstruction:
                ...
                break;
            case failedOverflow:
                System.out.println("Progarm has failed due to overflow");
                break;
...
// LOADING
    ...
    /**
     * Loads the PPPAM Object Program into code store from the named file
     * 
     * @param objectName
     * @throws FileNotFoundException 
     * @throws IOException
     */
    static void loadObjectProgram(String objectName) throws FileNotFoundException, IOException {
...
// RUNNING
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("********** PPPAM Interpreter (Java Version 2.1) **********");
        if(args.length == 1) 
            objectName = args[0];
        else
            objectName = "obj.pppam";
