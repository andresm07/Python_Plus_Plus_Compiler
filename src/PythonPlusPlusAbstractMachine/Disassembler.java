...
/**
 * Disassembles the PPPAM code in the given file, and displays the
 * instructions on standard output.
 *
 * For example:
 * <pre>
 *   java PythonPlusPlusAbstractMachine.Disassembler obj.pppam
 * </pre>
 *
 * <p>
...
public class Disassembler {
    ...
    /**
     * Writes a void n-field of a instruction
     */
    ...
    /**
     * Writes the name of the primitive routine with relative address d.
...
// DISASSEMBLE
    ...
    public static void main(String[] args) throws IOException {
        System.out.println ("********** PPPAM Disassembler (Sun Version 2.1) **********");
        if(args.length == 1) { 
            objectName = args[0];
        } else {
