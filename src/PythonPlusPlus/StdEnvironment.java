...
import PythonPlusPlus.AbstractSyntaxTrees.BinaryOperatorDeclaration;
import PythonPlusPlus.AbstractSyntaxTrees.ConstDeclaration;
import PythonPlusPlus.AbstractSyntaxTrees.FuncDeclaration;
import PythonPlusPlus.AbstractSyntaxTrees.ProcDeclaration;
import PythonPlusPlus.AbstractSyntaxTrees.TypeDeclaration;
import PythonPlusPlus.AbstractSyntaxTrees.TypeDenoter;
import PythonPlusPlus.AbstractSyntaxTrees.UnaryOperatorDeclaration;
...
public final class StdEnvironment {
    ...
    public static BinaryOperatorDeclaration andDecl, orDecl, addDecl, subtractDecl,
            multiplyDecl, divideDecl, moduleDecl, equalDecl, unequalDecl, lessDecl, notlessDecl,
            greaterDecl, notgreaterDecl;
