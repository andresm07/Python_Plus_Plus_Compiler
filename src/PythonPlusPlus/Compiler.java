...
import PythonPlusPlus.TreeDrawer.Drawer;
...
public class Compiler {
    ...
    /* The filename for the object program, normally obj.pppam. */
    
    static String objectName = "obj.pppam";
    ...
    /**
     * Compile the source program to PPPAM machine code
     * 
     * @param sourceName    the name of the file containing the source program
     * 
     * @param objectName    the name of the file containing the object program  
     * 
     * @param showingAST    true iff the AST is to be displayed after the contextual
    ...
    static boolean compileProgram(String sourceName, String objectName, boolean showingAST,
        ...
        System.out.println("********** " +
                           "Python++ Compiler (Java Version 2.1)" +
                           " **********");
...
//            }
    ...
    public static void main(String[] args) {
        ...
        if(args.length != 1) {
            System.out.println("Usaeg: tc filename");
            System.exit(1);
        }
